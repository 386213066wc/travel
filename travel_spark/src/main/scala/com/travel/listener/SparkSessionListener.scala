...
class SparkSessionListener  extends SparkListener{
  ...
  override def onTaskEnd(taskEnd: SparkListenerTaskEnd): Unit = {
    ...
    jedis.set("taskMetrics",JSON.toJSONString(jedisMap,SerializerFeature.WriteNonStringValueAsString))
    ...
    jedis.set("shuffleMetrics",JSON.toJSONString(shuffleMap,SerializerFeature.WriteNonStringValueAsString))
    ...
    jedis.set("inputOutputMetrics",JSON.toJSONString(input_output,SerializerFeature.WriteNonStringValueAsString))
    ...
    jedis.set("taskInfo",JSON.toJSONString(taskInfoMap,SerializerFeature.WriteNonStringValueAsString))
    jedis.close()
  }
}
